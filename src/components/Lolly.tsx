...
export default function Lolly({flavourTop, flavourMiddle, flavourBottom}) {
  return (
    ...
    <g id="Page-2" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Lolly">
            ...
            <use className="lollyBottom" fill={flavourBottom} fillRule="nonzero" href="#path-1"></use>
            <rect className="lollyTop" fill={flavourTop} fillRule="nonzero" mask="url(#mask-2)" x="-25" y="-9" width="224" height="134"></rect>
            <rect className="lollyMiddle" fill={flavourMiddle} fillRule="nonzero" mask="url(#mask-2)" x="-29" y="113" width="224" height="111"></rect>
